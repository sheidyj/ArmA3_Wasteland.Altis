...
private ["_vehicleClass", "_vehicle", "_createVehicle", "_vehicles", "_leader", "_speedMode", "_waypoint", "_vehicleName", "_numWaypoints", "_para", "_vysot", "_box1", "_box2", "_marker1", "_marker2"];

_setupVars =
{
	_missionType = "Patrol Helicopter";
...
_setupObjects =
{
	...
	{
		selectRandom [["O_Heli_Attack_02_black_F", "pawneeNormal"], ["O_Heli_Attack_02_black_F", "orcaDAGR"], "I_Heli_light_03_dynamicLoadout_F"];
	};
...
_successExec =
{
	...
	/*_vehicle spawn
	{
		...
		_box1 = createVehicle ["C_IDAP_supplyCrate_F", (getPosATL _veh) vectorAdd ([[_veh call fn_vehSafeDistance, 0, 0], random 360] call BIS_fnc_rotateVector2D), [], 5, "None"];
...
_this call sideMissionProcessor4;
