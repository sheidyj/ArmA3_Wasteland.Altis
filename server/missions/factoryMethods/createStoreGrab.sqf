/*
	...
	Edited by armatec, JoSchaap, [IT42O] MjDoc, AgentRev
...
*/
	...
	private ["_fileName", "_dir", "_pos", "_objList", "_objs", "_class", "_relPos", "_relDir", "_fuel", "_damage", "_init"];
		...
		_objList = call compile preprocessFileLineNumbers format ["server\missions\outposts\StoreGrab.sqf", _fileName];
		_objs = [];
