...
_setupVars =
{
	...
	[
		// Easy
		//[
		//	"Fast Cash Collection", // Marker text
		//	65420, // Money
		//	[
		//		[ // NATO convoy
		...
		// Medium
		//[
		//	"Medium Cash Collection", // Marker text
		//	80420, // Money
		//	[
		//		[ // NATO convoy
		//			["B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"], // Veh 1
		...
		// Hard
		[
			"Hard Cash Collection", // Marker text
			65420, // Money
			[
				[ // NATO convoy
					["B_APC_Wheeled_01_cannon_F", "B_APC_Tracked_01_rcws_F", "B_T_APC_Wheeled_01_cannon_F", "B_T_APC_Tracked_01_rcws_F"] // Veh 1
					//["B_MBT_01_cannon_F", "B_MBT_01_TUSK_F"], // Veh 2
					//["B_APC_Wheeled_01_cannon_F", "B_APC_Tracked_01_rcws_F", "B_APC_Tracked_01_AA_F"] // Veh 3
				],
				[ // CSAT convoy
					["O_APC_Tracked_02_cannon_F", "O_APC_Wheeled_02_rcws_v2_F", "O_T_APC_Tracked_02_cannon_ghex_F", "O_T_APC_Wheeled_02_rcws_v2_ghex_F"] // Veh 1
					//["O_MBT_02_cannon_F"], // Veh 2
					//["O_APC_Wheeled_02_rcws_F", "O_APC_Tracked_02_cannon_F", "O_APC_Tracked_02_AA_F"] // Veh 3
				],
				[ // AAF convoy
					["I_E_APC_tracked_03_cannon_F", "I_APC_Wheeled_03_cannon_F", "I_APC_tracked_03_cannon_F"] // Veh 1
		...
		[
			...
			"Military Cash Collection", // Marker text
			85420, // Money
			[
				[ // NATO convoy
					["B_MBT_01_TUSK_F", "B_T_MBT_01_TUSK_F", "O_T_MBT_02_cannon_ghex_F"] // Veh 1
				...
				[ // CSAT convoy
					["O_MBT_02_cannon_F", "O_MBT_04_command_F", "O_T_MBT_04_cannon_F"] // Veh 1
				...
				[ // AAF convoy
					["O_T_MBT_04_command_F", "I_MBT_03_cannon_F", "B_AFV_Wheeled_01_up_cannon_F"] // Veh 1
...
//	_missionHintText = format ["A convoy transporting <t color='%1'>%2</t> escorted by a <t color='%1'>%3</t> is en route to an unknown location.<br/>Stop them!", moneyMissionColor, _moneyText, _vehicleName];
	_missionHintText = format ["A <t color='%1'>%3</t> transporting <t color='%1'>%2</t> is en route to an unknown location.<br/>Stop them and take the money!", moneyMissionColor, _moneyText, _vehicleName];
...
_successExec =
{
	...
	{
		_cash = createVehicle ["Land_MoneyBills_01_stack_F", _lastPos, [], 5, "None"];
...
_this call moneyMissionProcessor5;
